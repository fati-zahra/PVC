...
public class AlgorithmeGenetique {
	...
	public AlgorithmeGenetique(int nbreSolution, double tauxMutation, double tauxCrossover, int nbreElitism,
			int tailleTournoi) {
		super();
	...
	public Sol initSolutions(int nbreVille)
	{
		Sol sol = new Sol(this.nbreSolution, nbreVille);
		return sol;
				
	}
	
	// le nombre de génération maximale est dépassé ????
	...
	public void definitScoreChemin(Sol solutions, Ville villes[])
	{
	 ...
	 */
	public Chemin select(Sol solutions)
	{
		Sol tournoi =  new Sol(this.tailleTournoi);
	...
	public Sol crossoverSolution(Sol solutions)
	{
		Sol nouvSolutions = new Sol(solutions.taille());
	...
	public Sol muterSolution(Sol solutions)
	{
		Sol nouvSolutions = new Sol(this.nbreSolution);
